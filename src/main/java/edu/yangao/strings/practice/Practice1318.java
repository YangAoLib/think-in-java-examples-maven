 ...
 * @author YangAo
 */
public class Practice1318 {

    /**
     * 注释的匹配正则
     */
    private static final Pattern EXEGESIS = Pattern.compile(".*?class\\s+(.*?)\\s+\\{", Pattern.MULTILINE);
     ...
     * 文件路径
     */
    public static final String FILE_PATH = "src/main/java/edu/yangao/strings/practice/";
