package edu.yangao.arrays;
//: arrays/ArraySearching.java
// Using Arrays.binarySearch().

import edu.yangao.net.mindview.util.ConvertTo;
import edu.yangao.net.mindview.util.Generated;
import edu.yangao.net.mindview.util.Generator;
import edu.yangao.net.mindview.util.RandomGenerator;
